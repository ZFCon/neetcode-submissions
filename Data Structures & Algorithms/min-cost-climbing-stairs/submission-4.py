...
class Solution:
    def minCostClimbingStairs(self, cost: List[int]) -> int:
        ...
        while q:
            ...
            cost_step_1 = cost[i + 1] if i + 1 < n else 0
            cost_step_2 = cost[i + 2] if i + 2 < n else 0

            # Append based on cost: the smaller future cost is appended first
            if cost_step_1 < cost_step_2:
